...
<h2><?php echo $name; ?></h2>
<p class="error">
	<strong>400 <?php echo __d('cake', 'Error'); ?>: </strong>
	<?php printf(
...
?>
		...
		<h3>For book reviews got to: <a href="http://www.yyztech.ca/posts/search/category:book_review/">Full Book List Here<a/>  </h3>
