...
<?php echo $this->Form->create('VenueFeature');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Venue Feature'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('VenueFeature.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('VenueFeature.id'))); ?></li>
