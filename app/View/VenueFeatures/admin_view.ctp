...
<h2><?php  echo __('Venue Feature');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($venueFeature['VenueFeature']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($venueFeature['VenueFeature']['name']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($venueFeature['VenueFeature']['group']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Venue Feature'), array('action' => 'edit', $venueFeature['VenueFeature']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Venue Feature'), array('action' => 'delete', $venueFeature['VenueFeature']['id']), null, __('Are you sure you want to delete # %s?', $venueFeature['VenueFeature']['id'])); ?> </li>
