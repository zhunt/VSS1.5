...
<div class="related">
	<h3><?php echo __('Related Map Location Types'); ?></h3>
	<?php if (!empty($map['MapLocationType'])): ?>
	...
	<?php
		$i = 0;
		foreach ($map['MapLocationType'] as $mapLocationType): ?>
		<tr>
			<td><?php echo $mapLocationType['id']; ?></td>
			<td><?php echo $mapLocationType['name']; ?></td>
			<td><?php echo $mapLocationType['map_id']; ?></td>
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'map_location_types', 'action' => 'view', $mapLocationType['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'map_location_types', 'action' => 'edit', $mapLocationType['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'map_location_types', 'action' => 'delete', $mapLocationType['id']), null, __('Are you sure you want to delete # %s?', $mapLocationType['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($map['MapLocation'] as $mapLocation): ?>
		<tr>
