...
<?php echo $this->Form->create('Post', array('type' => 'file')); ?>
	...
	<?php
		...
		echo $this->Form->input('dek', array('after' => '<span id="char_counter_dek"></span>') );
		echo $this->Form->input('excerpt');
		echo $this->Form->input('tease_quote');
		echo $this->Form->input('seo_title', array('after' => '<span id="char_counter_seo_title"></span>'));
		echo $this->Form->input('seo_desc', array('after' => '<span id="char_counter_seo_desc"></span>'));
		...
		echo $this->Form->input('image_1', array('type' => 'file', 'label' => '[Image 1]: ' . $this->data['Post']['image_1']));
                echo $this->Form->input('Post.image_1.remove', array('type' => 'checkbox'));
		echo $this->Form->input('image_2', array('type' => 'file', 'label' => '[Image 2]: ' . $this->data['Post']['image_2']));
                echo $this->Form->input('Post.image_2.remove', array('type' => 'checkbox'));
		echo $this->Form->input('image_3', array('type' => 'file', 'label' => '[Image 3]: ' . $this->data['Post']['image_3']));
                echo $this->Form->input('Post.image_3.remove', array('type' => 'checkbox'));
		echo $this->Form->input('image_4', array('type' => 'file', 'label' => '[Image 4]: ' . $this->data['Post']['image_4']));
                echo $this->Form->input('Post.image_4.remove', array('type' => 'checkbox'));
		echo $this->Form->input('image_5', array('type' => 'file', 'label' => '[Image 5]: ' . $this->data['Post']['image_5']));
                echo $this->Form->input('Post.image_5.remove', array('type' => 'checkbox'));
		echo $this->Form->input('image_6', array('type' => 'file', 'label' => '[Image 6]: ' . $this->data['Post']['image_6']));
                echo $this->Form->input('Post.image_6.remove', array('type' => 'checkbox'));
...
<?php echo $this->Html->scriptBlock("
	...
	$('#PostDek').keyup(function() {
		count = $('#PostDek').val().length;
		...
		$('#char_counter_dek').html(text);
		return false;									   
	});      

	$('#PostSeoTitle').keyup(function() {
		count = $('#PostSeoTitle').val().length;
	...
	$('#PostSeoDesc').keyup(function() {
		count = $('#PostSeoDesc').val().length;
