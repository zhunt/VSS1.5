<div class="images index">
	...
	<tr>
		...
		<td><?php echo h($image['Image']['basename']); ?>&nbsp;</td>
		<td><?php echo h($image['Image']['checksum']); ?>&nbsp;</td>
		<td><?php echo h($image['Image']['created']); ?>&nbsp;</td>
		<td><?php echo h($image['Image']['modified']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($image['Post']['name'], array('controller' => 'posts', 'action' => 'view', $image['Post']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($image['Venue']['name'], array('controller' => 'venues', 'action' => 'view', $image['Venue']['id'])); ?>
		</td>
		<td class="actions">
